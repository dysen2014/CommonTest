...
//        mBubbleColor = a.getColor(R.styleable.BubbleLayout_bl_bubbleColor, Color.WHITE);
        mBubbleColor = a.getColor(R.styleable.BubbleLayout_bl_bubbleColor, Color.parseColor("#80000000"));
        mStrokeWidth =
        ...
        int location = a.getInt(R.styleable.BubbleLayout_bl_arrowDirection, ArrowDirection.BOTTOM.getValue());
