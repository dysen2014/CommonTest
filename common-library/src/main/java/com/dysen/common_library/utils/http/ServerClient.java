...
public class ServerClient {
    ...
    private static final String HEART_BEAT_KPAD = "/pub/heartbeat_kpad"; // 心跳
    ...
    private static final String GET_STUDENT_LIST = "/sv-data/data/stu/stu_list";            // 获取学列表
    private static final String GET_STUDENT_INFO = "/sv-data/data/stu/stu_paging";    // 获取学生信息
    ...
    // 考勤接口
    private static final String GET_ATTENDANCE_YOUER_CONFIG = "/sv-kq/kq/conf_youer_get"; // 获取幼兒園考勤配置
    private static final String GET_ATTENDANCE_YOUER_COUNT = "/sv-kq/kq/sch_youer_static"; // 获取幼兒園考勤统计
    ...
    private static final String GET_RECIPSE = "/sv-xy/recipes/recipes_list_by_day"; // 食谱
    private static final String GET_VOICE_DEV = "/sv-data/dev/voice_dev_list"; // 获取播报设备
    ...
    public static final String RESPONSE_DATAS = "data"; // 数据
    //状态码
    ...
    // 参数
    public static final String APP_TYPE = "type";  // App 类型
    public static final String APP_PLAT = "plat";  // App 平台
    public static final String DAY_BEGIN = "dayb";  // 开始日期
    public static final String DAY_END = "daye";  // 结束日期
    public static final String DAY = "day";  // 当前日期
    ...
    // 单例
    private static ServerClient SERVER_CLIENT;
    ...
    private String mPassword; // 设备密码
    private String mDeviceID; // 设备ID
    private String mSchoolID; // 学校ID
    private String mClassID; // 班级ID
    private String mDeviceKey;  // 设备标识
    private boolean mIsInitial; // 初始化标志
     ...
     * 是否已经初始化
     *
     * @return 返回true如果已经初始化完成，否则返回false
     */
