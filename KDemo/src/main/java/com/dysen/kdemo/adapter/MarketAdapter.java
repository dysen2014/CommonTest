...
public class MarketAdapter extends SuperRecyclerAdapter<CommonBean.BtcQc> implements MagicIndicatorView.IOnListener {
    ...
    public void onItem(int index) {
        ...
        Tools.toast(kLineItemName_ls.getName()+"=====index======"+index);
